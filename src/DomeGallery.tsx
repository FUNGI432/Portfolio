...
const DEFAULT_IMAGES = [
  ...
  { src: imgBP, alt: 'Black Panther' },
  { src: imgI1, alt: 'Image i1' },
  { src: imgI2, alt: 'Image i2' },
  { src: imgI3, alt: 'Image i3' },
  { src: imgI4, alt: 'Image i4' },
  { src: imgI5, alt: 'Image i5' },
  { src: imgN1, alt: 'Image n1' },
  { src: imgN2, alt: 'Image n2' },
  { src: imgN3, alt: 'Image n3' },
  { src: imgN4, alt: 'Image n4' },
  { src: imgN5, alt: 'Image n5' },
  { src: imgN6, alt: 'Image n6' },
];
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      const el = focusedElRef.current as HTMLElement | null;
      if (!el) return;
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      // Trigger dynamic resizing natively
